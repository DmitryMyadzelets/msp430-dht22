...
//     P2DIR &= ~BIT0;     // Set pin to input direction
//     P2REN |= BIT0;            // Enable pin pullup/down resistor
//     P2SEL |= BIT0;      // Set pin as input for Timer1_A3.CCI0A
//     TA1CTL = TACLR;
...
//   case DHT_WAITING_ACK: // Waiting for DHT low level
...
//   case DHT_ACK_LOW: // Waiting for DHT high level
...
//   case DHT_ACK_HIGH: // Waiting for DHT low level before the first bit
//     TA1CTL = TACLR;
//     TA1CTL = TASSEL_2 | ID_0 | MC_2;
//     TA1CCTL0 = CM_1 | CCIS_0 | CAP | CCIE; // Capture on rising edge
...
//   case DHT_IN_BIT_LOW: // Waiting for DHT high level of the bit
//     TA1CTL = TACLR;
//     TA1CTL = TASSEL_2 | ID_0 | MC_2;
//     TA1CCTL0 = CM_2 | CCIS_0 | CAP | CCIE; // Capture on falling edge
...
//   case DHT_IN_BIT_HIGH: // Waiting for DHT low level end of the bit
